...
{/* Sensor Cards */}
          ...
          <div className="system-status-card">
            <div className="section-header">
              ...
              <div className={`system-badge ${deviceStatus.online ? "online" : "offline"}`}>
            ...
            <div className="system-status-grid">
              ...
              <div className="status-item">
                ...
                <div className="status-item-content">
                  <span>Gateway</span>
                  <strong className={deviceStatus.online ? "status-online" : "status-offline"}>
                    {deviceStatus.online ? "ONLINE" : "OFFLINE"}
                  </strong>
                </div>
                ...
                <span
                  className={`status-indicator ${
                    deviceStatus.online ? "indicator-online" : "indicator-offline"
                  }`}
                ></span>
              </div>
              ...
              <div className="status-item">
                ...
                <span
                  className={`led-indicator ${
                    deviceStatus.led === "ON" ? "led-on-indicator" : "led-off-indicator"
                  }`}
                ></span>
              </div>
